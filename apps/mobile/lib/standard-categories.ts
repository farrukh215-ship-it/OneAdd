...
export const STANDARD_CATEGORIES: Category[] = [
  { id: 'mobiles', name: 'Mobile Phones', slug: 'mobiles', icon: '\u{1F4F1}', count: 0 },
  { id: 'cars', name: 'Cars', slug: 'cars', icon: '\u{1F697}', count: 0 },
  ...
  { id: 'pets', name: 'Pets', slug: 'pets', icon: '\u{1F43E}', count: 0 },
  { id: 'services', name: 'Services', slug: 'services', icon: '\u2699\uFE0F', count: 0 },
];
